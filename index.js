...
is31Flavors(copiedList);

/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
Corporate has come to you with an idea for a new flavor:
...
Use the addFlavor function below to do the following:
  1. Receive an array in the first parameter that will
  take the flavors array as an argument
  2. Receive a string in the second parameter
  that will take the new flavor as as an argument
  ...
  should return the array ["Rainbow Sherbert", "Banana Nut Fudge",...
  "Vanilla Burnt Almond"]
*/
...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 4: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
Houston, we have a problem! There are now 32 flavors in the
originalFlavors array! Your task is to remove an item from
...
function removeLastFlavor(list){
  let newList = list;
  let poppped = list.pop();
  /*console.log(newList);*/
  return newList;
}

removeLastFlavor(copiedList);
...
Use the getFlavorByIndex function below to do the following:
  1. Recieve an array in the first parameter that will take the
  flavors array as an argument
  2. Receive a number in the second parameter that will take
  the the desired index as an argument
  3. Return the flavor located at the received index position

  For example: running getFlavorByIndex(originalFlavors, 2)
  would return "Black Walnut", assuming Rainbow Sherbert has
  been added successfully
*/


function getFlavorByIndex(list, index){
  let indexedItem = list[index];
  console.log(indexedItem);
  return indexedItem;
}

getFlavorByIndex(copiedList, 3);


/*🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
As corporate wants to add more and more flavors to their lineup,
...
Your task is to get an index by flavor name, and remove that single
flavor from the array.

Use the removeFlavorByName function below to do the following:
  1. Receive an array in the first parameter that will take the
  flavors array as an argument
  2. Receive a string in the second parameter that will take the
  flavor name as as an argument
  3. Remove the received flavor from the received array
  4. Return the resulting array that now contains one less flavor

  For example: running removeFlavorByName(originalFlavors, "Rocky Road")
  would return an array with the a length of 30 because Rocky Road would have
  been removed.
...
/*🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 7: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
July 7th is "World Chocolate Day" and Baskin Robins wants to create
promotional materials highlighting all of their chocolate flavors.
Your task is to write a function that checks every item in the array
for a string and returns a new array called filteredArray with only the values
 that contain the received string. This would allow you to be able to filter for
...
Use the filterByWord function below to do the following:
  1. Receive an array in the first parameter that will take the
  flavors array as an argument
  2. Receive a string in the second parameter that will take
  the filter value as as an argument (example: "chocolate")
  ...
  ["Chocolate", "Chocolate Almond", "Chocolate Chip", "Chocolate Fudge",
  "Chocolate Mint", "Chocolate Ribbon"]
...
/* STRETCH 1: Write a function that returns the average
number of words in an array. You should be able to use
this function for any array, but can test with originalFlavors.
...
Use the getAverageWordLength function below to do the following:
  ...
  For example: getAverageWordLength(originalFlavors) should
...
/* 💪💪💪💪💪💪💪💪💪💪 STRETCH 2: 💪💪💪💪💪💪💪💪💪
Baskin Robins now offers new flavors, seasonal flavors,
and even regional flavors. Write a function that will
randomly select a total of 31 flavors
from originalFlavors, currentFlavors, seasonalFlavors,
and regionalFlavors and store it in an array called
randomFlavors.

Use the getRandomFlavors function and new arrays
below to do the following:
  1. Receive the four arrays with all the differnet
  flavors (originalFlavors is above, the others are below)
  2. Randomly pick flavors from all four arrays
  3. Return a new array called randomFlavors that has a lenght of 31

  For example: getRandomFlavors(originalFlavors,
  newFlavors, seasonalFlavors, regionalFlavors)
  might return ["Strawberry Cheesecake", "Eggnog,"..."
  Chocolate"].
*/



function getRandomFlavors(list1, list2, list3, list4){
  var newRandomFlavorList = [];
  if (newRandomFlavorList.length < list1.length) {
    for (let i = 0; i < list1.length; i++){
      var randomListIndex = Math.round(Math.random() * list2.length)
      newRandomFlavorList.push(list1[randomListIndex]);
      newRandomFlavorList.push(list2[randomListIndex]);
      newRandomFlavorList.push(list3[randomListIndex]);
      newRandomFlavorList.push(list4[randomListIndex]);
    }
  }
...
getRandomFlavors(originalFlavors, newFlavors, regionalFlavors, seasonalFlavors);
